...
export default function Register() {
    ...
    const getPasswordStrength = (password: string) => {
        ...
        if (password.length < 6) return { strength: 33, label: "Yếu", color: "bg-red-500" };
        if (password.length < 10) return { strength: 66, label: "Trung bình", color: "bg-yellow-500" };
                    ...
                    <div className="backdrop-blur-xl bg-white/70 dark:bg-gray-800/70 rounded-3xl shadow-2xl border border-white/20 dark:border-gray-700/50 p-8 md:p-10">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        className="pl-10 h-11 bg-white/50 dark:bg-gray-700/50 border-gray-200 dark:border-gray-600 focus:border-purple-500 dark:focus:border-purple-400 rounded-xl transition-all"
                                        required
                                    />
                                </div>
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        className="pl-10 pr-10 h-11 bg-white/50 dark:bg-gray-700/50 border-gray-200 dark:border-gray-600 focus:border-purple-500 dark:focus:border-purple-400 rounded-xl transition-all"
                                        required
                                    />
                                    <button
                                        type="button"
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            ...
                            <Button
                                ...
                                className="h-11 bg-white/50 dark:bg-gray-700/50 hover:bg-white dark:hover:bg-gray-700 border-gray-200 dark:border-gray-600 rounded-xl transition-all"
                            >
                                <svg className="w-5 h-5 mr-2" fill="#f29418ff" viewBox="0 0 24 24">
